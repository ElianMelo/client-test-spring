...
public class ClientResourceTests {
	...
	/* insert deveria retornar “created” (código 201), bem como um produto criado, quando os
		dados forem válidos */
	@Test
	...
	/* update retornar “not found” (código 204) quando o id não existir. Fazer uma assertion
	...
	public void findAllShouldReturnList() throws Exception {
		ResultActions result = mockMvc.perform(get("/clients/findAll")
				.accept(MediaType.APPLICATION_JSON));
		result.andExpect(status().isOk());
	}
